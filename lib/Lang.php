...
class Lang
{
    ...
    private static function getLangAsArray() :array
    {
        ...
        if ($domain instanceof Domain) {
            ...
            $privacy_policy = \rex_article::get(intval(Wsm::getConfig("wsm_domain_imprint_id")));
            $imprint = \rex_article::get(intval(Wsm::getConfig("wsm_domain_privacy_policy_id")));
        }
    ...
    private static function getConsentModal() :array
    {
        ...
        if ($domain instanceof Domain) {
            ...
            $privacy_policy = \rex_article::get((int)Wsm::getConfig("wsm_domain_privacy_policy_id"));
            
            $imprint = \rex_article::get((int)Wsm::getConfig("wsm_domain_imprint_id"));
        }
        if($privacy_policy instanceof \rex_article && $imprint instanceof \rex_article) {
